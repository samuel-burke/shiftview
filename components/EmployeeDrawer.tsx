...
import { Employee, Schedule, getShiftType, isHere, SHIFT_COLORS } from "../data/mockData";
...
export default function EmployeeDrawer({ open, employee, schedule, nowMinutes, onClose }: Props) {
  useEffect(() => {
      ...
      <div style={{
        ...
        <div style={{ padding: "8px 24px 44px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              <div style={{
                ...
                background: `${shiftColor}22`, border: `2px solid ${shiftColor}55`,
                display: "flex", alignItems: "center", justifyContent: "center",
                fontSize: 16, fontWeight: 800, color: shiftColor,
              }}>
                {employee.avatar}
              </div>
              <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 24 }}>
            {[
              { label: "Start",      value: scheduled ? schedule.startLabel : "—" },
              { label: "End",        value: scheduled ? schedule.endLabel   : "—" },
