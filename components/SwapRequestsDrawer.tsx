    ...
    <div className="bg-card border border-slate-800/60 rounded-2xl px-4 py-4">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 py-3.5 rounded-xl bg-gradient-to-r from-blue-500 to-violet-500 text-white font-bold text-xs cursor-pointer border-none hover:brightness-110 transition-[filter]"
        >
          Approve
        </button>
        <button
          ...
          className="flex-1 py-3.5 rounded-xl bg-transparent border border-slate-700 text-red-400 font-semibold text-xs cursor-pointer hover:bg-red-500/20 hover:border-red-500/40 transition-colors"
        >
          Deny
        </button>
      </div>
